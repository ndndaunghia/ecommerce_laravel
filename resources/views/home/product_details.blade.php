    ...
    <section>
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-4 p-5"><img class="card-img-top mb-5 mb-md-0" src="product/{{ $product->image }}" alt="..." /></div>
                <div class="col-md-8">
                    ...
                    <div class="d-flex">
                        <input class="form-control text-center mr-md-3" id="inputQuantity" type="number" value="1" min="1" style="width: 4rem" />
